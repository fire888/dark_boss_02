//import { _M as m4 } from '/_CORE/_M/_m'
...
export const rotateArr = _M.rotateVerticesY
...
export const rotateArrY = _M.rotateVerticesY
...
export const rotateArrZ  = _M.rotateVerticesZ
...
export const translateArr = _M.translateVertices
...
export const transformArr = (arr, x = 0, y = 0, z = 0, r = 0) => { 
    _M.rotateVerticesY(arr, r)
    _M.translateVertices(arr, x, y, z)
}
//export const transformArr = (arr, x = 0, y = 0, z = 0, r = 0) => {
